...
@Model(name = "lpl-spring")
@Component
class LplSpringService {
    @Resource
    ...
    suspend fun searchTodayLpl(sender: User, messageChain: MessageChain, subject: Contact): Message {
    ...
    suspend fun searchDayLpl(sender: User, messageChain: MessageChain, subject: Contact): Message {
